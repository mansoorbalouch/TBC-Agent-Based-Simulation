...
classdef Platform
    ...
    methods
        ...
        % function createAgentsAndTokens(platFormObject, numAgents)
            ...
            myAgents = Agent.empty(0,numAgents);  %Not Needed
            myTokens =[];    %Not Needed
            ...
            for term=1:total_years
                for i = 1:agentsBornYearly(term)
                    ...
                    if newAgent.purposeCategory == "Creator"
                        ...
                        platFormObject.myTokens = [platFormObject.myTokens, newToken];

                        tokenID = tokenID + 1;
                    end
                    % myAgents = [myAgents, newAgent];   %Not Needed
                    myAgents(1,agentID) = newAgent;

                    % platFormObject.myAgents = [platFormObject.myAgents, newAgent];

                    % platFormObject.myAgents(1,agentID) = newAgent;
