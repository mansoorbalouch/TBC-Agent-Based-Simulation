class BondingCurve:
    ...
    def __init__(self, functionType, param1, param2, param3=None):
        ...
        if self.functionType == "linear":
            ...
            self.deltaSupply = lambda s, m, n, c, costDeltaSupply: (m / (n + 1)) * ((s + costDeltaSupply) ** (n + 1) - s ** (n + 1))
            self.costDeltaSupply = None  # Specify the costDeltaSupply function for the polynomial curve
